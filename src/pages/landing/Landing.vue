  ...
  data() {
    return {
      ...
      destinations: [
        ...
        title: "北卡罗来纳州夏洛特",
        titleEn: "Charlotte, North Carolina",
        hotels: 12324,
        avg: 423.00
      },
        {
          cover: require("@/assets/images/destinations/3C2D9FF2684D114988C8083327CB3705.jpg"),
          title: "纽约萨拉纳克湖",
          titleEn: "Saranac Lake, New York",
          hotels: 53241,
          avg: 223.00
        },
        {
          cover: require("@/assets/images/destinations/4E15721EB1ABB929D3B69BA617496457.jpg"),
          title: "马萨诸塞科德角",
          titleEn: "Cape Cod, Massachusetts",
          hotels: 61543,
          avg: 642.11
        },
        {
          cover: require("@/assets/images/destinations/5A36935841ABBB111B1A937A72F93F8A.jpg"),
          title: "西班牙马洛卡帕尔马",
          titleEn: "Palma de Mallorca, Spain",
          hotels: 443,
          avg: 142.11
        },
        {
          cover: require("@/assets/images/destinations/5C44ED8B2FD822A6A76509734E9FD74A.jpg"),
          title: "西班牙伊维萨岛",
          titleEn: "Ibiza, Spain",
          hotels: 3532,
          avg: 562.12
        ...
        {
          cover: require("@/assets/images/destinations/5FBAD154BF283053F6A26C8DB6552DC5.jpg"),
          title: "马萨诸塞科德角",
          titleEn: "Cape Cod, Massachusetts",
          hotels: 7621,
          avg: 321.40
        ...
        {
          cover: require("@/assets/images/destinations/27BBA6E9B4612B1A008753CB3BFDD77A.jpg"),
          title: "夏威夷大岛",
          titleEn: "Big Island, Hawaii",
          hotels: 2515,
          avg: 152.40
        },
        {
          cover: require("@/assets/images/destinations/33A9AE906C54656B9F51797715D5711D.jpg"),
          title: "圣托马斯",
        ...
        {
          cover: require("@/assets/images/destinations/51ABDAD664B8B6A90CE24BEACDC80167.jpg"),
          title: "圣十字",
          titleEn: "Saint Croix",
          hotels: 361,
          avg: 513
        ...
        {
          cover: require("@/assets/images/destinations/65F13A0F87CDC459893A1BDF9EEAEA6C.jpg"),
          title: "加拿大卡尔加里",
          titleEn: "Calgary, Canada",
          hotels: 51213,
          avg: 624
        },
        {
          cover: require("@/assets/images/destinations/69B79884BA9D769D8F4E54B580DD30EF.jpg"),
          title: "哥斯达黎加圣何塞",
          titleEn: "San Jose, Costa Rica",
          hotels: 64525,
          avg: 242
        },
        {
          cover: require("@/assets/images/destinations/945BCA47C64ECDF12FCB7021A2802357.jpg"),
          title: "圣马丁",
        ...
        {
          cover: require("@/assets/images/destinations/1578AB5232EA4F40FAD87EE95F210B18.jpg"),
          title: "克罗地亚萨格勒布",
          titleEn: "Zagreb, Croatia",
          hotels: 241,
          avg: 98
        },
        {
          cover: require("@/assets/images/destinations/03517FA97446D943A782063A17A997E7.jpg"),
          title: "加利福尼亚棕榈泉",
          titleEn: "Palm Springs, California",
          hotels: 982,
          avg: 241
        },
        {
          cover: require("@/assets/images/destinations/08483BCCF1DF6E481634A39E7A97A55E.jpg"),
          title: "夏威夷考艾岛",
          titleEn: "Kauai, Hawaii",
          hotels: 2524,
          avg: 532
        },
        {
        ...
        },
        {
          ...
          title: "牙买加金斯敦",
          titleEn: "Kingston, Jamaica",
          hotels: 142,
          avg: 529
        },
        {
          cover: require("@/assets/images/destinations/A4B34EAAE924D4295C9880FE2C2C0558.jpg"),
          title: "大溪地",
          titleEn: "Tahiti",
          hotels: 12,
          avg: 341
        ...
        {
          cover: require("@/assets/images/destinations/AC9F1068E13A79B8CAFFC5927F11BFC4.jpg"),
          title: "多明尼加共和国",
        ...
        {
          cover: require("@/assets/images/destinations/AF51E8A2CED509AC8E819BB9C39DFBE7.jpg"),
          title: "伯利兹",
          titleEn: "Belize",
          hotels: 287,
          avg: 220
        ...
        {
          cover: require("@/assets/images/destinations/C767DB8A338C2272AC8794477D0238E6.jpg"),
          title: "博内尔",
          titleEn: "Bonaire",
          hotels: 351,
          avg: 424
        ...
        {
          cover: require("@/assets/images/destinations/C1497D4FA30635E4F6E523679FCE3EF3.jpg"),
          title: "北卡罗莱纳州阿什维尔",
          titleEn: "Asheville, North Carolina",
          hotels: 6512,
          avg: 320
        },
        {
          cover: require("@/assets/images/destinations/F243F3760A3C27F2E20AAD25ABCE72F2.jpg"),
          title: "悉尼，澳大利亚",
          titleEn: "Sydney, Australia",
          hotels: 221521,
          avg: 1422
        },
        {
          cover: require("@/assets/images/destinations/FAF4755CD28CF6977355006002E34042.jpg"),
          title: "马萨诸塞州楠塔基特",
          titleEn: "Nantucket, Massachusetts",
          hotels: 1422,
          avg: 254
        },
        {
          cover: require("@/assets/images/destinations/FE6239551FF23CE128DF17981EC24E88.jpg"),
          title: "加利福尼亚棕榈泉",
          titleEn: "Palm Springs, California",
          hotels: 5121,
          avg: 421
  ...
  methods: {
    ...
    downloadData() {
      ...
      let popular = [];
            // 随机去除6个
            for (var i = 0; i < 6; i++){
              var index = Math.floor(Math.random() * this.destinations.length);
              if (index < this.destinations.length)
                popular.push(this.destinations.splice(index,index + 1)[0])
            }
