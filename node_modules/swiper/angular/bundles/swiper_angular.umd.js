    ...
    ***************************************************************************** */
    ...
    var SwiperComponent = /** @class */ (function () {
        function SwiperComponent(_ngZone, elementRef, _changeDetectorRef, _platformId) {
            ...
            this.updateVirtualSlides = function (virtualData) {
                ...
                _this.style = _this.swiperRef.isHorizontal()
                    ? (_j = {},
                        _j[_this.swiperRef.rtlTranslate ? 'right' : 'left'] = virtualData.offset + "px",
                        _j) : {
        ...
        SwiperComponent.prototype.initSwiper = function () {
            var _this = this;
            var _j = getParams(this), swiperParams = _j.params, passedParams = _j.passedParams;
            ...
            this._ngZone.runOutsideAngular(function () {
                ...
                Object.assign(swiperParams.on, {
                    ...
                    _slideClasses: function (_, updated) {
                        updated.forEach(function (_j, index) {
                            var slideEl = _j.slideEl, classNames = _j.classNames;
        ...
        SwiperComponent.prototype.updateInitSwiper = function (changedParams) {
            ...
            this._ngZone.runOutsideAngular(function () {
                var _j = _this.swiperRef, currentParams = _j.params, pagination = _j.pagination, navigation = _j.navigation, scrollbar = _j.scrollbar, virtual = _j.virtual, thumbs = _j.thumbs;
